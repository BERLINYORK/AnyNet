...
parser.add_argument('--datatype', default='2015',
                    help='datapath')
parser.add_argument('--datapath', default='/home/berlin/test/data_scene_flow/training/', help='datapath')
...
parser.add_argument('--pretrained', type=str, default='/home/berlin/test/AnyNet-master/checkpoint/kitti2015_ck/checkpoint.tar',
                    help='pretrained model path')
parser.add_argument('--split_file', type=str, default='/home/berlin/test/AnyNet-master/checkpoint/kitti2015_ck/split.txt')
